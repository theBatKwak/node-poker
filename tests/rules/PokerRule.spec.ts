...
describe('PokerRule', () => {
  ...
  it('should detect a three of a kind', () => {
    ...
    const result = pokerRule.have(cards, commonCards)
    expect(result).toStrictEqual({ value: 12, reason: 'three of a kind', secondValue: 11, sideKick: 10 })
  })
  it('should detect two pairs', () => {
    ...
    const result = pokerRule.have(cards, commonCards)
    expect(result).toStrictEqual({ value: 12, secondValue: 11, reason: 'two pairs', sideKick: 10 })
  })
  ...
  it('should detect a high card', () => {
    ...
    const result = pokerRule.have(cards, commonCards)
    expect(result).toStrictEqual({ value: 12, reason: 'high card', secondValue: 11, sideKick: 10 })
  })
})
